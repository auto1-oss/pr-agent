...
from pr_agent.algo.utils import (format_code_suggestion_metadata,
...
class TestParseCodeSuggestion:
    def test_format_code_suggestion_metadata_hidden_by_default(self):
        assert format_code_suggestion_metadata("possible issue", 7) == ""

    def test_format_code_suggestion_metadata_renders_label_and_score_when_enabled(self):
        assert format_code_suggestion_metadata("possible issue", 7, enable_badges=True) == " [possible issue, importance: 7]"

    def test_format_code_suggestion_metadata_renders_label_only_when_enabled(self):
        assert format_code_suggestion_metadata("possible issue", enable_badges=True) == " [possible issue]"
